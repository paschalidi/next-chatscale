...
var ChatProvider = function(param) {
    var children = param.children, organizationToken = param.organizationToken, wsEndpoint = param.wsEndpoint, _param_options = param.options, options = _param_options === void 0 ? {
...
var useChat = function() {
    var context = React.useContext(Index);
    if (!context) {
